return {
  {
    ...
    config = function()
      ...
      vim.keymap.set(
        ...
        "<leader>pg",
        builtin.grep_string,
        { desc = "Telescope: Grep files for string under the cursor" }
      )
      ...
      vim.keymap.set(
        ...
        vim.tbl_extend("error", opts, { desc = "Telescope: Goto definition" })
      )
      vim.keymap.set(
        "n",
        "<leader>D",
        builtin.lsp_type_definitions,
        vim.tbl_extend("error", opts, { desc = "Telescope: Goto type definition" })
      )
      vim.keymap.set(
        "n",
        "gi",
        builtin.lsp_implementations,
        vim.tbl_extend("error", opts, { desc = "Telescope: Show implementations" })
      )
